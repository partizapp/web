        ...
        >
          ...
          <div className="relative">
            ...
            <div className="flex flex-col items-center gap-5">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 opacity-40 pointer-events-none select-none">
                <a
                  href="#"
                  className="inline-flex items-center gap-3 bg-white text-background px-8 py-4 rounded-2xl font-black text-sm w-full sm:w-auto justify-center"
                >
                ...
                <a
                  href="#"
                  className="inline-flex items-center gap-3 border border-white/20 text-white px-8 py-4 rounded-2xl font-black text-sm w-full sm:w-auto justify-center"
                >
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
